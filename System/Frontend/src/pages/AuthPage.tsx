      ...
      <div className="relative z-10 w-full flex items-center justify-center px-4">
        ...
        >
          <div className="flex items-center gap-3 mb-4">
            <motion.div
              className="bg-white w-20 h-20 rounded-full shadow-lg flex items-center justify-center overflow-hidden shrink-0 ring-2 ring-[#5b2fc1]/20"
              animate={{
            ...
            >
              <img
                src={logoImg}
                alt="OBE Academic System Logo"
                className="h-16 w-16 object-cover scale-125"
              />
            </motion.div>

            <div className="text-left pt-1">
              <h2 className="text-xl font-bold text-[#1F2A44] leading-tight">
                OBE Academic System
              </h2>
          ...
          >
            <p className="text-xs text-center text-gray-500">
              © {new Date().getFullYear()} OBE Academic System. All rights reserved.
            </p>
          </motion.div>
        </motion.div>
      </div>
