    ...
    <div className="w-full min-h-screen bg-[#f5f6fb] overflow-hidden flex">
      <div className="relative w-full h-screen">
        ...
        <motion.div
          ...
          ring-4 ring-[#a88bff50] flex items-center justify-center"
          style={{
            perspective: 1200,
          }}
        >
          <motion.div
            className="w-[78%] h-[78%] rounded-full bg-white shadow-inner flex items-center justify-center overflow-hidden"
            animate={{
              rotateX: [0, 18, 0, -18, 0],
              rotateY: [0, 180, 360],
              rotateZ: [0, 6, 0, -6, 0],
          ...
          >
            <img src={logo} alt="OBE Academic System Logo" className="w-[95%] h-[95%] object-cover scale-110" />
          </motion.div>
        </motion.div>
        ...
        >
          <div className="px-12 py-16 w-full">
            ...
            <motion.h1
              ...
              className="text-4xl md:text-5xl font-extrabold text-[#5b2fc1] leading-tight"
            >
              OBE Academic System
            </motion.h1>

            <p className="text-gray-600 mt-2 mb-8">
              Outcome-Based Education • Smart Assessment • Modern Campus
            </p>
