          ...
          i === index ? (
            ...
            >
              ...
              <motion.div
               ...
               className="absolute left-16 top-24 hidden md:flex items-center justify-center w-60 h-60 rounded-full bg-white/95 
border-[5px] border-[#1F2A44] shadow-2xl backdrop-blur-sm overflow-hidden"
              >
                <img src={logo} alt="OBE Academic System Logo" className="w-[90%] h-[90%] object-cover scale-110" />
              </motion.div>
            </motion.div>
          ) : null
        )}
