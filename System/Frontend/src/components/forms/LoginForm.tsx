        ...
        <div className={`relative transform ${isAnimating ? 'translate-y-10 opacity-0' : 'translate-y-0 opacity-100'} transition-all duration-1000 ease-out`}>
          ...
          <form onSubmit={handleLogin} className="p-10 bg-white rounded-lg shadow-2xl w-96 backdrop-blur-sm bg-opacity-95 border border-indigo-100">
            <div className="absolute -top-14 left-0 right-0 flex flex-col items-center gap-2">
              <div className="w-16 h-16 rounded-full bg-white shadow-lg flex items-center justify-center ring-2 ring-white/60 overflow-hidden -mb-2">
                <img src={logoImg} alt="OBE Academic System Logo" className="w-14 h-14 object-cover scale-125" />
              </div>
              <div className="bg-gradient-to-r from-blue-600 to-indigo-700 text-white px-8 py-3 rounded-lg font-bold text-xl shadow-lg flex items-center gap-2">
                <span>✦</span> OBE Academic System <span>✦</span>
              </div>
            </div>
