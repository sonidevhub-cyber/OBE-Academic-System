...
class Feedback(models.Model):
    ...
    department = models.ForeignKey('academics.Department', on_delete=models.CASCADE, related_name='feedbacks')
...
class FeedbackNotification(models.Model):
    hod = models.ForeignKey('hods.HOD', on_delete=models.CASCADE, related_name='hod_feedback_notifications')
    ...
    def __str__(self):
        return f"Notification for {self.hod.user.username}: {self.message}"