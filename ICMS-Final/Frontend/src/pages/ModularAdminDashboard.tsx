...
type TabId = 'dashboard' | 'students' | 'instructors' | 'program-setup' | 'courses' | 'events' | 'announcements' | 'hod' | 'principal' | 'profile' | 'pending-transfers' | 'promotion-management' | 'users';
