...
import AlumniTab from '../views/pages/AlumniTab';
...
type TabId = 'dashboard' | 'students' | 'instructors' | 'program-setup' | 'curriculum' | 'courses' | 'events' | 'announcements' | 'hod' | 'profile' | 'pending-transfers' | 'freeze' | 'promotion-management' | 'users' | 'retake-management' | 'alumni';
    ...
    try {
      ...
      try {
        ...
        if (transfersResponse.ok) {
          ...
          console.error('Error fetching frozen students:', err);
      }
    } catch (error) {
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-indigo-100 text-sm opacity-80">
                  {activeTab === 'dashboard' ? 'OBE Academic System' :
