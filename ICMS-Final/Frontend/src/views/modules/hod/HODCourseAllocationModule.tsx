  ...
  const submitAction = async () => {
    try {
      ...
      if (actionType === 'approve') {
        await coordinatorService.approveCourseAllocation(selectedAllocation.allocation_id, {
          comments
        });
        ...
        <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-100">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-green-600 mt-1">{allocations.filter((a: any) => a.status === 'approved' || a.status === 'active').length}</p>
            </div>
        ...
        <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-100">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-red-600 mt-1">{allocations.filter((a: any) => a.status === 'rejected').length}</p>
            </div>
      ...
      {pendingAllocations.length > 0 ? (
        <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-100">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            {pendingAllocations.map((allocation: any) => (
              <motion.div
    ...
    <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-100">
      ...
      {reviewedAllocations.length > 0 ? (
        <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-4">
          {reviewedAllocations.map((allocation: any) => (
